...
class QueriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create query" do
    assert_difference('Query.count') do
      post queries_url, params: { query: { city: @query.city, description: @query.description, email: @query.email, name: @query.name, phone: @query.phone, state: @query.state } }
    end
  ...
  test "should update query" do
    patch query_url(@query), params: { query: { city: @query.city, description: @query.description, email: @query.email, name: @query.name, phone: @query.phone, state: @query.state } }
